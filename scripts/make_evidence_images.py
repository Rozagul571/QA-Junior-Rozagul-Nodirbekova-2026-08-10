...
CODE_FINDINGS = [
    ...
    ("WEB-4", "Signup 'All fields are required' — fragile catch-all validation",
     f"{WEB}/lib/ui/screen-components/un-protected/authentication/signup-with-email/index.tsx", 64, 77, [70],
     "enatega-multivendor-web/…/signup-with-email/index.tsx:70"),
